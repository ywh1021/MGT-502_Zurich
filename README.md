...
> **Github Link:** https://github.com/ywh1021/MGT-502_Zurich.git
...
- **Models 6 & 7**: weights (CF 75%, Content 20%, Popularity 5%) were found through iterative manual search in Model 6 — sweeping weights, identifying the peak, then narrowing the range. For Model 7, these weights were kept and only the Graph component weight (20%) was tuned via 5-fold CV.
